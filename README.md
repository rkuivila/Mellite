...
- The document elements are an arbitrarily ordered collection of objects which constitute your composition: Audio files (also called Audio Graphemes), timelines (also called ProcGroups), numbers and strings, code fragments, folders which help you to organise your elements.
